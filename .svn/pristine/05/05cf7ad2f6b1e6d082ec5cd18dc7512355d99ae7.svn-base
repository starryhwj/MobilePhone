...
var KTDatatableRecordSelectionDemo = function () {
    ...
    var localSelectorDemo = function () {
        ...
        options.search = {
            input: $('#generalTreasureMissionSearch'),
            onEnter: true,
        };

        var datatable = $('#datatable_TreasureMission').KTDatatable(options);
...
var getStatusSearch = function () {
    ...
    search('treasuremissionstatus', statusSearch)
}

var search = function (param, value) {
    var datatable = $('#datatable_TreasureMission').KTDatatable()
