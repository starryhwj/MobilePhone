...
/****** Object:  View [dbo].[VAllMissions]    Script Date: 12/09/2019 18:27:19 ******/
SET ANSI_NULLS ON
GO
...
FROM         dbo.Web_followmission LEFT JOIN
                      ...
                      dbo.Web_tiktokaccount ON dbo.Web_mobilephone.TikTokAccount_id = dbo.Web_tiktokaccount.id
UNION
SELECT     '刷宝任务' AS MissionName, dbo.Web_treasuremission.id, dbo.Web_treasuremission.[Status], dbo.Web_treasuremission.[CreateTime], 
                      dbo.Web_treasuremission.[StartTime], dbo.Web_treasuremission.[EndTime], dbo.Web_treasuremission.[FailReason], 
                      dbo.Web_treasuremission.MobilePhone_id, dbo.Web_tiktokaccount.NickName
