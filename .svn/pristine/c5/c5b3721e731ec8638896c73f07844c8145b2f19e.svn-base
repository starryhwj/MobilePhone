...
var KTDatatableRecordSelectionDemo = function () {
    ...
    var localSelectorDemo = function () {
        ...
        var datatable = $('#datatable_device_deliver').KTDatatable(options);
        ...
        datatable.on('click', '[data-diliver-id]', function () {
            ...
            $.ajax({
                type: "POST",
                url: $("#getdevicebyuserid_url").text(),
                data: {
                    csrfmiddlewaretoken: document.getElementsByName("csrfmiddlewaretoken")[0].value,
                    id: id
                },
...
var KTDatatableDevice = function () {
    ...
    var localSelectorDemo = function () {
        ...
        var datatable = $('#modal_datatable_device_deliver').KTDatatable(options);
                ...
                datatable.on('kt-datatable--on-layout-updated', function () {
                    if (!alreadyInitSelect) {
                        if (document.getElementById("id_edit_mission_divice").value != '') {
                            ...
                            localStorage.setItem('modal_datatable_device_deliver-1-checkbox', JSON.stringify(storage));
                        }
    ...
    var search = function (param, value) {
        isSearch = true
        if (JSON.parse(localStorage.getItem('modal_datatable_device_deliver-1-checkbox')) != null) {
            searchStorage['selectedRows'] = JSON.parse(localStorage.getItem('modal_datatable_device_deliver-1-checkbox'))['selectedRows']
            searchStorage['unselectedRows'] = JSON.parse(localStorage.getItem('modal_datatable_device_deliver-1-checkbox'))['unselectedRows']
        }     
        var datatable = $('#modal_datatable_device_deliver').KTDatatable()
...
var EditDevice = function () {
    $.ajax({
        type: "POST",
        url: $("#userdevicediliver_url").text(),
        data: {
            csrfmiddlewaretoken: document.getElementsByName("csrfmiddlewaretoken")[0].value,
