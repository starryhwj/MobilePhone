    ...
    var options = {
        ...
        columns: [{
            ...
            template: function (row) {
                ...
                return '<span class="kt-badge ' + status[row.IsFollow].class +
                    ' kt-badge--inline kt-badge--pill">' + status[row.IsFollow].title +
                    '</span>';
            },
        }, {
            field: 'CommentText',
            ...
            $.ajax({
                ...
                success: function (response, status, xhr, $form) {
                    if (response != 'Error') {
                        ...
                        if (isfollow == false) {
                            $('#id_edit_isfollow_false').selected()
                        } else {
                            $('#id_edit_isfollow_true').selected()
                        }
                    }
                }
            });
...
var EditMission = function () {
    ...
    $.ajax({
        ...
        data: {
            ...
            isfollow: $("input[name='edit_isfollow']:checked").val(),
        },
        success: function (response, status, xhr, $form) {
            if (response != 'Error') {
...
var initcreatemodal = function () {
    ...
    document.getElementById("id_create_mission_isfollowcount").value = '';
    ...
    if (document.getElementById("id_create_device_id").value == '') {
        ...
        $.ajax({
            ...
            data: {
                ...
                isfollowcount: document.getElementById("id_create_mission_isfollowcount").value,
