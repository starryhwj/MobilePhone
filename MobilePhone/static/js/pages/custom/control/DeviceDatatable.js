(function ($) {
    ...
    function DeviceDatatable(obj, deviceopitons) {
        tiggerObj = obj;
        deviceOpitons = deviceopitons || {};
        if (deviceOpitons['isinit'] == true) {
            this.initDom();
        } else {
            tiggerObj.modal('show');
        }       
    }
                    ...
                    source: {
                        read: {
                            ...
                            params: {
                                ...
                                iscommodity: deviceOpitons['iscommodity'],
                                'query[owner]': '',
                            }
                        },
                    },
    ...
    $.fn.deviceDatatable = function (deviceopitons) {
        var dt = new DeviceDatatable(this, deviceopitons);
        return dt;
    };
})(jQuery);